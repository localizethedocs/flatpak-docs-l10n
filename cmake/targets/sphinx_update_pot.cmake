...
message(STATUS "Copying 'base.html' file to the sphinx templates directory...")
file(MAKE_DIRECTORY "${PROJ_OUT_REPO_DOCS_TMPLS_DIR}")
file(COPY_FILE
    "${PROJ_CMAKE_CUSTOM_DIR}/base.html"
    "${PROJ_OUT_REPO_DOCS_TMPLS_DIR}/base.html")
remove_cmake_message_indent()
message("")
message("From: ${PROJ_CMAKE_CUSTOM_DIR}/base.html")
message("To:   ${PROJ_OUT_REPO_DOCS_TMPLS_DIR}/base.html")
message("")
restore_cmake_message_indent()
